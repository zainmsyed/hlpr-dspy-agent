...
class DocumentChunker:
    ...
    def __init__(self, default_strategy: str = "sentence"):
    ...
    def chunk_text(
        ...
        try:
            ...
            msg = f"Failed to chunk text with {strategy_name} strategy: {e}"
    ...
    def get_chunk_info(self, text: str, chunks: list[str]) -> dict:
